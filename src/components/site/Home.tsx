              ...
              return (
                <li key={p.name}>
                  ...
                  >
                    ...
                    <ArrowRight className="ml-auto h-3.5 w-3.5 -translate-x-2 text-primary-glow opacity-0 transition-all group-hover:translate-x-0 group-hover:opacity-100" aria-hidden="true" />
                  </a>
                </li>
              );
            })}
